...
def warn_if_run_as_root():
    # type: () -> None
    """Output a warning for sudo shop on Unix.

    In a virtual environment, sudo pip still writes to virtualenv.
    On Windows, shop may run pip as Administrator without issues.
    This warning only applies to Unix root shop outside of virtualenv.
    """
