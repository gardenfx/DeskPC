...
class SchemaGenerator(BaseSchemaGenerator):
    ...
    def get_keys(self, subpath, method, view):
        ...
        /shop/                   ("shop", "list"), ("shop", "create")
        /shop/{pk}/              ("shop", "read"), ("shop", "update"), ("shop", "delete")
        /shop/enabled/           ("shop", "enabled")  # custom viewset list action
        /shop/{pk}/star/         ("shop", "star")     # custom viewset detail action
        /shop/{pk}/groups/       ("shop", "groups", "list"), ("shop", "groups", "create")
        /shop/{pk}/groups/{pk}/  ("shop", "groups", "read"), ("shop", "groups", "update"), ("shop", "groups", "delete")
        """
        ...
        if is_custom_action(action):
            # Custom action, eg "/shop/{pk}/activate/", "/shop/active/"
        ...
        # Default action, eg "/shop/", "/shop/{pk}/"
        return named_path_components + [action]
