...
class URLPathVersioning(BaseVersioning):
    ...
    urlpatterns = [
        re_path(r'^(?P<version>[v1|v2]+)/shop/$', users_list, name='shop-list'),
        re_path(r'^(?P<version>[v1|v2]+)/shop/(?P<pk>[0-9]+)/$', users_detail, name='shop-detail')
    ]
...
class NamespaceVersioning(BaseVersioning):
    ...
    # shop/urls.py
    urlpatterns = [
        path('/shop/', users_list, name='shop-list'),
        path('/shop/<int:pk>/', users_detail, name='shop-detail')
    ]

    # urls.py
    urlpatterns = [
        path('v1/', include('shop.urls', namespace='v1')),
        path('v2/', include('shop.urls', namespace='v2'))
    ]
